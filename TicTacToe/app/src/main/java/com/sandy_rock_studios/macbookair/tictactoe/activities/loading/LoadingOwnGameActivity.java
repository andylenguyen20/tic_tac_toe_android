...
import com.sandy_rock_studios.macbookair.tictactoe.util.tasks.PostGameTask;

import java.util.Timer;
import java.util.TimerTask;

public class LoadingOwnGameActivity extends AppCompatActivity implements Loader, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_loading_own_game);
    ...
    public void lookForMatch() {
        new PostGameTask(myID, new GameCreationHandler() {
            @Override
    ...
    public void startGame(String gameID) {
        matchMade = true;
        Intent intent = new Intent(LoadingOwnGameActivity.this, GameActivity.class);
        Bundle b = new Bundle();
            ...
            new DeleteGameTask(myGameID, new ConditionHandler() {
                ...
                public void handle(boolean condition) {
                    if(!condition){
                        ...
                        Intent intent = new Intent(LoadingOwnGameActivity.this, MainActivity.class);
                        startActivity(intent);
                        finish();
                    }
                }
